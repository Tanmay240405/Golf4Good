...
const plans = [
  {
    ...
    price: '$0',
    period: 'forever',
    description: 'Track your personal scores and explore the community.',
    features: [
      'Score Tracking (up to 5 scores)',
      'Basic Performance Analytics',
      'No Entry in Cash Draws',
      'No Charity Support features',
    ],
  ...
  },
  {
    ...
    price: '$19',
    period: '/month',
    description: 'For active golfers looking to win prizes and give back.',
    features: [
      'Score Tracking (up to 5 scores)',
      'Entry into Monthly Cash Draws',
      'Support Registered Charities',
      'Choose & Support any Charity',
    ],
    cta: 'Start Pro Trial',
  ...
  },
  {
    ...
    price: '$190',
    period: '/year',
    description: 'Get 2 months free. Best value for committed golfers.',
    features: [
      'Everything in Monthly',
      'Support Charities All Year',
      'Entry in Monthly & Special Draws',
